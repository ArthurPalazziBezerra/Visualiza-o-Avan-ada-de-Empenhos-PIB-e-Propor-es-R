...
```{r}
#armazenamento do data frame em csv na variavel "dados"
...
```{r}
#Exibição de sumario das colunas do dataframe
...
```{r}
#Alguns gráficos de boxplot e hist da coluna ValorEmpenho
